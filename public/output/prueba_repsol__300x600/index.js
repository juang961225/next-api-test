...
.from(".txt2_1", 3, { autoAlpha: 0, y:10, ease: "power2.out" }, "second")
...
.from(".txt3_1", 3, { autoAlpha: 0, y:10, ease: "power2.out" }, "third")
.from(".txt3_2", 3, { autoAlpha: 0, y:10, ease: "power2.out" }, "third")
